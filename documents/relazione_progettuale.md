...
### 6.0 Esperienza multi-ruolo più evoluta (sessione robusta e navigazione intelligente):
...
### 6.1 Personalizzazione commerciale reale - offerte intelligenti e bacheca dinamica:
...
- Area cliente con consumo delle offerte e filtraggio in base alle preferenze alimentari facoltative dell'utente, così da proporre contenuti più pertinenti.
- Supporto a scenari multipli di comunicazione commerciale (offerte presenti, assenza preferenze, offerte non compatibili).

### 6.2 Qualità del checkout superiore:
...
### 6.3 Gestione operativa ordini più completa (stati, conferme e notifiche):
...
### 6.6 Dashboard statistiche:

- Presenza di una vista dedicata alle statistiche ristoratore (`ristoratore/statistiche.html`) con (KPI – Key Performance Indicators) e aggregazioni.
